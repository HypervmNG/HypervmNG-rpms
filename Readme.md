...
This is the repository that will host the source files for the packages we will use for suporting HypervmNG.
...
Please use HypervmNG Github  issues pages for any reports and bugs. There is forum as well available at: http://

# Licensing - AGPLv3

    HypervmNG, Server Virtualization GUI for OpenVZ and Xen
